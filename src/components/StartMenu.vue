    ...
    data() {
        return {
            ...
            apps: [
                ...
                { label: 'Photos', icon: 'src/assets/icons/photos.png', active: false, click: this.none },
                { label: 'Your Phone', icon: 'src/assets/icons/your-phone.png', active: false, click: this.none },
                { label: 'Notepad', icon: 'src/assets/icons/notepad.png', active: false, click: this.none },
                { label: 'Calculator', icon: 'src/assets/icons/calculator.png', active: false, click: this.none },
                { label: 'Spotify', icon: 'src/assets/icons/spotify.png', active: false, click: this.none },
                { label: 'VS Code', icon: 'src/assets/icons/vscode.png', active: false, click: this.none },
                { label: 'Terminal', icon: 'src/assets/icons/terminal.png', active: false, click: this.none },
                { label: 'Github', icon: 'src/assets/icons/github.png', active: false, click: this.none },
                { label: 'Discord', icon: 'src/assets/icons/discord.png', active: false, click: this.none },
            ],
            ...
            recommendedApps: [
                ...
                { label: 'VS Code', subLabel: 'Yesterday at 4:24 PM', icon: 'src/assets/icons/vscode.png', active: false, click: this.none },
                { label: 'Photos', subLabel: 'Last week', icon: 'src/assets/icons/photos.png', active: false, click: this.none },
            ]
